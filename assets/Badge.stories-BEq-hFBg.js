import{c as C,a as z,r as v,b as _,t as V,n as F,o as A}from"./vue.esm-bundler-DUmJvHEW.js";import{I as e}from"./Icon-lJEXtgpb.js";import"./iframe-BXJEXoxe.js";import"../sb-preview/runtime.js";const E={class:"badge__container"},L={__name:"Badge",props:{themeColor:{type:String,default:"error",validator:n=>["primary","secondary","tertiary","success","warning","error","info"].includes(n)},badgeLabel:{type:[String,Number,null]},maxValue:{type:Number},isDot:{type:Boolean,default:!1},isIcon:{type:Boolean,default:!1},position:{type:String,default:"default",validator:n=>["default","top-right"].includes(n)}},setup(n){const o=n,h=C(()=>{const i=typeof+o.badgeLabel=="number"||!isNaN(+o.badgeLabel);return console.log(i),i&&o.badgeLabel>o.maxValue?`${o.maxValue}+`:o.badgeLabel});return(i,x)=>(A(),z("span",E,[v(i.$slots,"default"),_("span",{class:F(["badge__content",{[`badge-color-${o.themeColor}`]:o.themeColor,"badge__content-isDot":o.isDot,[`badge__position-${o.position}`]:o.position,"badge__content-isIcon":o.isIcon}])},V(o.isDot?"":h.value),3)]))}},a=L;L.__docgenInfo={exportName:"default",displayName:"Badge",description:"",tags:{},props:[{name:"themeColor",type:{name:"string"},defaultValue:{func:!1,value:"'error'"},values:["primary","secondary","tertiary","success","warning","error","info"]},{name:"badgeLabel",type:{name:"string|number|null"}},{name:"maxValue",type:{name:"number"}},{name:"isDot",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"isIcon",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"position",type:{name:"string"},defaultValue:{func:!1,value:"'default'"},values:["default","top-right"]}],slots:[{name:"default"}],sourceFiles:["/Users/jony_worker/Documents/90_外部檔案/DED-WDS_VUE/libs/src/ui/element/Badge/Badge.vue"]};const k={components:{Icon:e},title:"Design System/Badge",component:a,tags:["autodocs"],argTypes:{themeColor:{description:"徽章主題顏色",control:{type:"select"},options:["primary","secondary","tertiary","success","warning","error","info"]},badgeLabel:{description:"顯示在徽章上的文字內容",control:{type:"text"}},maxValue:{description:"徽章的最大顯示值，超過該值時將顯示加號（+）",control:{type:"Object"}},isDot:{description:"啟用點狀顯示，無文字內容的徽章",control:{type:"boolean"}},isIcon:{description:"設定徽章與Icon的顯示位置",control:{type:"boolean"}},position:{description:"指定徽章的位置",control:{type:"radio"},options:["default","top-right"]}},parameters:{docs:{title:"Badge",description:{component:"徽章組件的呈現及說明。"}}}},s={name:"徽章樣式",args:{position:"top-right",isIcon:!0,isDot:!0},render:n=>({components:{Badge:a,Icon:e},setup(){return{args:n}},template:`
        ...
        `}),parameters:{controls:{}}},t={name:"徽章位置",args:{position:"top-right",isIcon:!0,isDot:!0},render:n=>({components:{Badge:a,Icon:e},setup(){return{args:n}},template:`
        ...
        `}),parameters:{controls:{}}},r={name:"徽章最大值",args:{position:"top-right",badgeLabel:1e3,maxValue:99,isIcon:!0,isDot:!0},render:n=>({components:{Badge:a,Icon:e},setup(){return{args:n}},template:`
            <div style="display:flex; gap:60px; margin-bottom: 24px;">
        ...
        `}),parameters:{controls:{}}},c={name:"徽章顏色",args:{position:"top-right",badgeLabel:1e3,maxValue:99,isIcon:!0,isDot:!0,themeColor:"primary"},render:n=>({components:{Badge:a,Icon:e},setup(){return{args:n}},template:`
...
}`,...(B=(b=r.parameters)==null?void 0:b.docs)==null?void 0:B.source}}};var f,y,D;c.parameters={...c.parameters,docs:{...(f=c.parameters)==null?void 0:f.docs,source:{originalSource:`{
  name: "徽章顏色",
  args: {
    position: "top-right",
    badgeLabel: 1000,
...
}`,...(D=(y=c.parameters)==null?void 0:y.docs)==null?void 0:D.source}}};const T=["BadgeStyle","BadgePosition","BadgeMaxValue","BadgeThemeColor"];export{r as BadgeMaxValue,t as BadgePosition,s as BadgeStyle,c as BadgeThemeColor,T as __namedExportsOrder,k as default};
