import{g as _,c as v,a as r,n as y,t as k,o as f,e as V,k as h}from"./vue.esm-bundler-tTYhI9fy.js";const E=["for"],I=["id","name","value","checked"],S={class:"radio-text"},b={__name:"Radio",props:{themeColor:{type:String,default:"primary",validator:e=>["primary","secondary","tertiary","success","warning","error","info"].includes(e)},inputId:{type:String},name:{type:String},value:{type:String},label:{type:String},modelValue:{type:[Array,String]}},emits:["update:modelValue"],setup(e,{emit:n}){const a=e,s=n,D=u=>{s("update:modelValue",u.target.value)},l=_(()=>a.modelValue===a.value);return(u,w)=>(f(),v("label",{for:a.inputId,class:"radio"},[r("input",{class:"radio-input",type:"radio",id:a.inputId,name:a.name,value:a.value,checked:l.value,onChange:D},null,40,I),r("div",{class:y(["radio-icon",l.value?`radio-checked-${a.themeColor}`:`radio-unchecked-${a.themeColor}`])},null,2),r("span",S,k(a.label),1)],8,E))}},i=b;b.__docgenInfo={exportName:"default",displayName:"Radio",description:"",tags:{},props:[{name:"themeColor",type:{name:"string"},defaultValue:{func:!1,value:'"primary"'},values:["primary","secondary","tertiary","success","warning","error","info"]},{name:"inputId",type:{name:"string"}},{name:"name",type:{name:"string"}},{name:"value",type:{name:"string"}},{name:"label",type:{name:"string"}},{name:"modelValue",type:{name:"array|string"}}],events:[{name:"update:modelValue"}],sourceFiles:["/Users/jony_worker/Documents/90_外部檔案/DED-WDS_VUE/libs/src/ui/element/Radio/Radio.vue"]};const C={__name:"RadioGroup",props:{customClass:{type:String,default:""},direction:{type:String,validator:e=>["row","column"].includes(e),default:"row"}},setup(e){const n=e;return(a,s)=>(f(),v("div",{class:y(["radio-container",`radio-container-${n.direction}`])},[V(a.$slots,"default")],2))}};C.__docgenInfo={exportName:"default",displayName:"RadioGroup",description:"",tags:{},props:[{name:"customClass",type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"direction",type:{name:"string"},defaultValue:{func:!1,value:"'row'"},values:["row","column"]}],slots:[{name:"default"}],sourceFiles:["/Users/jony_worker/Documents/90_外部檔案/DED-WDS_VUE/libs/src/ui/element/Radio/RadioGroup.vue"]};const F={title:"Design System/Radio",component:i,tags:["autodocs"],argTypes:{themeColor:{description:"主題顏色",control:{type:"select"},options:["primary","secondary","tertiary","success","warning","error","info"]},label:{description:"Radio選項文字",control:{type:"text"}},value:{description:"Radio選項值",control:{type:"text"}},name:{description:"Radio表單用name",control:{type:"text"}},modelValue:{description:"Radio的綁定值",control:{type:"Object"}},direction:{description:"Radio群組方向",control:{type:"select"},options:["row","column"]}},parameters:{docs:{title:"單選框",description:{component:"單選框組件的呈現及說明。"}}}},o={name:"標準 Radio Button",args:{label:"DefaultRadio",name:"DefaultRadio",value:"DefaultRadio",themeColor:"primary"},render:e=>({components:{Radio:i},setup(){const n=h("");return{args:e,isRadioPicked:n}},template:`
            <Radio
                :label="args.label"
                :value="args.value"
                :name="args.name"
...
}`,...(g=(R=t.parameters)==null?void 0:R.docs)==null?void 0:g.source}}};const G=["DefaultRadio","MultipleRadio"];export{o as DefaultRadio,t as MultipleRadio,G as __namedExportsOrder,F as default};
