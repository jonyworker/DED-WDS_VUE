import{_ as t}from"./Avatar-r6cCUcWf.js";import"./vue.esm-bundler-qOdkfnRX.js";import"./Image-bIVxNfei.js";import"./index-Bb4qSo10.js";import"./Icon-BjTfNPlk.js";import"./iframe-BIuOw2Wo.js";import"../sb-preview/runtime.js";const y={title:"Design System/Avatar",component:t,tags:["autodocs"],argTypes:{shape:{description:"形狀",control:{type:"select"},options:["circle","square"]},size:{description:"Avatar 尺寸",control:{type:"select"},options:["xsmall","small","medium","large"]},username:{description:"使用者名稱",control:{type:"text"}},status:{description:"狀態",control:{type:"select"},options:["default","online","idle","busy","offline"]},imageSrc:{description:"圖片連結",control:{type:"text"}},imageAlt:{description:"圖片描述",control:{type:"text"}},limit:{description:"在 AvatarGroup 中控制顯示的 Avatar 數量上限",control:{type:"number",min:0,max:5,step:1}},className:{description:"客製化樣式",control:{type:"text"}}},parameters:{docs:{title:"Avatar頭像",description:{component:"Avatar 組件的呈現及說明。"}}}},e={name:"主要項目",args:{shape:"circle",size:"large",username:"JonyWu",status:"online",imageSrc:"https://picsum.photos/320/240",imageAlt:"alt text",className:""},render:a=>({components:{Avatar:t},setup(){return{args:a}},template:`
            <Avatar
                :shape="args.shape"
                :size="args.size"
