import{c as s,a as z,e as A,f as _,n as S,o as d}from"./vue.esm-bundler-tTYhI9fy.js";const V={key:0,class:"divider-content"},x={__name:"Divider",props:{layout:{type:String,default:"horizontal",validator:e=>["horizontal","vertical"].includes(e)},type:{type:String,default:"solid",validator:e=>["solid","dashed","dotted"].includes(e)},themeColor:{type:String,validator:e=>["primary","secondary","tertiary","success","warning","error","info"].includes(e)},width:{type:String,default:"xsmall",validator:e=>["xsmall","small","medium","large","xlarge"].includes(e)},align:{type:String,validator:e=>["start","center","end"].includes(e)}},setup(e){const t=e;return(l,E)=>(d(),s("div",{class:S(["divider",`divider-${t.layout}`,`divider-width-${t.width}`,`divider-${t.type}`,t.themeColor?`divider-${t.themeColor}`:"",l.$slots.default?`divider-${t.align}`:""])},[l.$slots.default?(d(),s("div",V,[z("b",null,[A(l.$slots,"default")])])):_("",!0)],2))}},r=x;x.__docgenInfo={exportName:"default",displayName:"Divider",description:"",tags:{},props:[{name:"layout",type:{name:"string"},defaultValue:{func:!1,value:'"horizontal"'},values:["horizontal","vertical"]},{name:"type",type:{name:"string"},defaultValue:{func:!1,value:'"solid"'},values:["solid","dashed","dotted"]},{name:"themeColor",type:{name:"string"},values:["primary","secondary","tertiary","success","warning","error","info"]},{name:"width",type:{name:"string"},defaultValue:{func:!1,value:'"xsmall"'},values:["xsmall","small","medium","large","xlarge"]},{name:"align",type:{name:"string"},values:["start","center","end"]}],slots:[{name:"default"}],sourceFiles:["/Users/jony_worker/Documents/90_外部檔案/DED-WDS_VUE/libs/src/ui/element/Divider/Divider.vue"]};const F={title:"Design System/Divider",component:r,tags:["autodocs"],argTypes:{layout:{description:"Divider分隔線方向",control:{type:"radio"},defaultValue:"horizontal",options:["horizontal","vertical"]},type:{description:"Divider分隔線種類",control:{type:"select"},defaultValue:"solid",options:["solid","dashed","dotted"]},themeColor:{description:"主題顏色",control:{type:"select"},options:["default","primary","secondary","tertiary","success","warning","error","info"]},width:{description:"Divider分隔線寬度",control:{type:"select"},options:["xsmall / 1px","small / 2px","medium / 4px","large / 6px","xlarge / 8px"]},align:{description:"Divider分隔線上文字位置",control:{type:"radio"},options:["start","center","end"]}},parameters:{docs:{title:"分隔線",description:{component:"分隔線組件的呈現及說明。"}}}},a={name:"分隔線種類",args:{layout:"horizontal",themeColor:"Default",width:"small"},render:e=>({components:{Divider:r},setup(){return{args:e}},template:`
