import{B as D}from"./Button-CBm87ohw.js";import{r as a,s as F,J as V,c as f,b as S,q as z,d as H,C as N,E as P,K as M,T as R,F as L,L as $,o as p,x as I,n as w,G as j,t as U,e as x}from"./vue.esm-bundler-Bm7qTojY.js";import{_ as q}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./index-Bb4qSo10.js";import"./Icon-D7BxWnBt.js";import"./iframe-Cuot_jaF.js";import"../sb-preview/runtime.js";const B={__name:"Tooltip",props:{content:{type:String},showArrow:{type:Boolean,default:!0},placement:{type:String,default:"top",validator:r=>["top-left","top","top-right","right-top","right","right-bottom","bottom-right","bottom","bottom-left","left-top","left","left-bottom"].includes(r)}},setup(r){const i=r,d=a(null),g=a(null),h=a({}),b=`tooltip-${Math.random().toString(36).substring(2,9)}`,s=a(!1),E=()=>{s.value=!0,$(l)},C=()=>{s.value=!1},l=()=>{if(!d.value||!g.value||!s.value)return;const t=d.value.getBoundingClientRect(),e=g.value.getBoundingClientRect();let o,n;switch(i.placement){case"top-right":o=t.top-e.height-12,n=t.right-e.width;break;case"top":o=t.top-e.height-12,n=t.left+t.width/2-e.width/2;break;case"top-left":o=t.top-e.height-12,n=t.left;break;case"right-top":o=t.top,n=t.right+12;break;case"right":o=t.top+t.height/2-e.height/2,n=t.right+12;break;case"right-bottom":o=t.bottom-e.height,n=t.right+12;break;case"bottom-right":o=t.bottom+12,n=t.right-e.width;break;case"bottom":o=t.bottom+12,n=t.left+t.width/2-e.width/2;break;case"bottom-left":o=t.bottom+12,n=t.left;break;case"left-top":o=t.top,n=t.left-e.width-12;break;case"left":o=t.top+t.height/2-e.height/2,n=t.left-e.width-12;break;case"left-bottom":o=t.bottom-e.height,n=t.left-e.width-12;break}h.value={top:`${o}px`,left:`${n}px`,position:"fixed"}};return F(()=>{window.addEventListener("scroll",l),window.addEventListener("resize",l)}),V(()=>{window.removeEventListener("scroll",l),window.removeEventListener("resize",l)}),(t,e)=>(p(),f(L,null,[S("div",{ref_key:"tooltipTriggerRef",ref:d,class:"tooltip-trigger",onMouseenter:E,onMouseleave:C,"aria-describedby":b},[z(t.$slots,"default",{},void 0,!0)],544),(p(),H(R,{to:"body"},[N(M,{name:"fade"},{default:P(()=>[s.value?(p(),f("div",{key:0,id:b,ref_key:"tooltipContentRef",ref:g,style:I(h.value),class:w(["tooltip-content",i.placement])},[j(U(i.content)+" ",1),i.showArrow?(p(),f("div",{key:0,class:w(`tooltip-arrow ${i.placement}`)},null,2)):x("",!0)],6)):x("",!0)]),_:1})]))],64))}},u=q(B,[["__scopeId","data-v-9d265e96"]]);B.__docgenInfo={exportName:"default",displayName:"Tooltip",description:"",tags:{},props:[{name:"content",type:{name:"string"}},{name:"showArrow",type:{name:"boolean"},defaultValue:{func:!1,value:"true"}},{name:"placement",type:{name:"string"},defaultValue:{func:!1,value:"'top'"},values:["top-left","top","top-right","right-top","right","right-bottom","bottom-right","bottom","bottom-left","left-top","left","left-bottom"]}],slots:[{name:"default"}],sourceFiles:["D:/98_測試/DED-WDS_VUE/libs/src/ui/element/Tooltip/Tooltip.vue"]};const Y={components:{Tooltip:u},title:"Design System/Tooltip",component:u,tags:["autodocs"],argTypes:{content:{description:"顯示 Tooltip 文字",control:{type:"text"}},showArrow:{description:"顯示 Tooltip 箭頭",control:{type:"boolean"}},placement:{description:"控制 Tooltip 位置",control:{type:"select"},options:["top-left","top","top-right","right-top","right","right-bottom","bottom-right","bottom","bottom-left","left-bottom","left","left-top"]}},parameters:{docs:{title:"Tooltip",description:{component:"Tooltip組件的呈現及說明。"}},slots:{default:{description:"任何被包裝的物件都會成為 tooltip 的觸發器",template:"{{ args.default }}"}}}},c={name:"Tooltip 基礎樣式",args:{content:"Hi, Hi~ Nice to meet you!",showArrow:!0,placement:"bottom-left"},render:r=>({components:{Tooltip:u,Button:D},setup(){return{args:r}},template:`
            <Tooltip 
...
}`,...(y=(T=c.parameters)==null?void 0:T.docs)==null?void 0:y.source}}};var A,k,_;m.parameters={...m.parameters,docs:{...(A=m.parameters)==null?void 0:A.docs,source:{originalSource:`{
  name: "Tooltip 顯示位置",
  args: {
    content: '',
    showArrow: true
