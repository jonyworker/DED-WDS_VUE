import{r as k,d as B,C as b,E as x,K as H,T as S,o as g,M as c,c as f,b as t,q as s,e as w,f as E,x as $}from"./vue.esm-bundler-Bm7qTojY.js";import{B as y}from"./Button-CBm87ohw.js";import{_ as A}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./index-Bb4qSo10.js";import"./Icon-D7BxWnBt.js";import"./iframe-Cuot_jaF.js";import"../sb-preview/runtime.js";const r=k(!1),F=()=>({showDialogStatus:r,showDialog:()=>{r.value=!0},closeDialog:()=>{r.value=!1}}),I={class:"dialog-wrapper"},N={class:"dialog-container"},R={class:"dialog-header"},T={class:"dialog-body"},V={class:"dialog-footer"},l={__name:"Dialog",props:{},setup(o){const e=F();return(a,n)=>(g(),B(S,{to:"#dialog"},[b(H,{name:"dialog"},{default:x(()=>[c(e).showDialogStatus.value?(g(),f("div",{key:0,class:"dialog-mask",onClick:n[0]||(n[0]=C=>c(e).closeDialog())},[t("div",I,[t("div",N,[t("div",R,[s(a.$slots,"dialogHeader")]),t("div",T,[s(a.$slots,"dialogBody")]),t("div",V,[s(a.$slots,"dialogFooter")])])])])):w("",!0)]),_:3})]))}};l.__docgenInfo={exportName:"default",displayName:"Dialog",description:"",tags:{},slots:[{name:"dialogHeader"},{name:"dialogBody"},{name:"dialogFooter"}],sourceFiles:["D:/98_測試/DED-WDS_VUE/libs/src/ui/element/Dialog/Dialog.vue"]};const z={class:"fakeContent",role:"presentation","aria-hidden":"true"},j={class:"fakeContent--text"},_={__name:"FakeContent",props:{height:{type:String}},setup(o){const e=o,a=E(()=>e.height?`${e.height}px`:"auto");return(n,C)=>(g(),f("div",{style:$({height:a.value})},[t("div",z,[t("b",j,[s(n.$slots,"default",{},void 0,!0)])])],4))}},M=A(_,[["__scopeId","data-v-e3ed1f03"]]);_.__docgenInfo={exportName:"default",displayName:"FakeContent",description:"",tags:{},props:[{name:"height",type:{name:"string"}}],slots:[{name:"default"}],sourceFiles:["D:/98_測試/DED-WDS_VUE/libs/src/ui/utility/FakeContent/FakeContent.vue"]};const J={components:{Dialog:l},title:"Design System/Dialog",component:l,tags:["autodocs"],argTypes:{dialogHeader:{description:"Dialog 的 header 插槽，適合顯示主題或重要信息，支持 HTML 和文字內容。",control:{type:"text"}},dialogBody:{description:"Dialog 的 body 插槽，用於顯示主要內容。可包含文字、圖片、列表或任何其他組件。",control:{type:"text"}},dialogFooter:{description:"Dialog 的 footer 插槽，通常用於顯示按鈕或其他結尾內容，如確認、取消或其他操作。",control:{type:"text"}}},parameters:{docs:{title:"Dialog",description:{component:"Dialog 組件的呈現及說明。"}}}},i={name:"Dialog 觸發樣式",args:{dialogHeader:'<div class="title title-level-2 title-undefined">Replace Image?</div>',dialogBody:'<p>A file named "example.png" already exist! Do you what to replace it?</p>',dialogFooter:'<div style="display: flex; justify-content: flex-end; gap: 16px"><button class="button button-text button-fit button-text-error" @click="dialog.closeDialog()" >Cancel</button><button class="button button-contained button-fit button-contained-error" @click="dialog.closeDialog()">Replace</button></div>'},render:o=>({components:{Dialog:l,Button:y},setup(){const e=F();return{args:o,dialog:e}},template:`
            <Dialog>
...
}`,...(h=(D=d.parameters)==null?void 0:D.docs)==null?void 0:h.source}}};const P=["DialogClick","DialogSlotStyle"];export{i as DialogClick,d as DialogSlotStyle,P as __namedExportsOrder,J as default};
